...
todo_box = tkinter.Listbox(list_frame,height=10, width=25, font=("Cascadia code",18), bd=0, background="green", highlightthickness=0, selectbackground="lightgreen", activestyle="none")
